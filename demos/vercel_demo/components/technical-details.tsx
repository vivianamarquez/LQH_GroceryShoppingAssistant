  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          The local demo uses Q4 for both models. This web version runs the
          original Q4 in the browser with wllama and calls the tuned deployment
          on LQH, with <strong>no system prompt for the tuned model</strong>.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        ...
        <p>
          ...
          Next.js routes on Vercel. Server routes call the hosted LQH model and
          Kroger; the original model runs on the visitor’s device with wllama.
        </p>
      </>
    ),
  },
    ...
    <div className="space-y-8">
      <header className="rounded-[2rem] bg-ink px-6 py-8 text-white sm:px-9">
        ...
        <div className="mt-6 flex flex-wrap gap-x-6 gap-y-2 text-sm text-lime">
          ...
          <span>Browser Q4 + hosted tuned model</span>
        </div>
      </header>
